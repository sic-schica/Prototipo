  $(document).ready(function () {
      ...
      var navListItems = $('div.setup-panel-doc div a'),
              allWells = $('.setup-content-doc'),
              allNextBtn = $('.nextBtn');
      ...
      allNextBtn.click(function(){
          var curStep = $(this).closest(".setup-content-doc"),
...
*/
      ...
      allPreviewBtn.click(function(){
  		    var curStep = $(this).closest(".setup-content-doc"),
              curStepBtn = curStep.attr("id"),
  			previewStepWizard = $('div.setup-panel-doc div a[href="#' + curStepBtn + '"]').parent().prev().children("a");
  		previewStepWizard.removeClass('disabled').trigger('click');
  	});

    $('div.setup-panel-doc div a.stepwizard-active').trigger('click');
